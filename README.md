...
|----------------|--------|--------|--------|--------|
| InversionNet   | 0.0073 | 0.0297 | 0.9876 | 0.9850 |
| ViT-Inversion  | 0.0067 | 0.0268 | 0.9908 | 0.9892 |



## Contributing

First and foremost, the reproducibility of OpenPros benchmarks is guaranteed by a number of public resources, listed below. Our team also promises to maintain the platform and support further developments based on the community feedback.
